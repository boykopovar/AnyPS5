...
public:
    void WriteU8(std::vector<std::uint8_t>& buf, std::size_t offset, std::uint8_t v) const override;
    ...
    void AppendU8(std::vector<std::uint8_t>& buf, std::uint8_t v) const override;
    void AppendU16(std::vector<std::uint8_t>& buf, std::uint16_t v) const override;
    void AppendU32(std::vector<std::uint8_t>& buf, std::uint32_t v) const override;

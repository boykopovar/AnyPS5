...
int64_t APS5_VABI pread_nid_disambig1_nid_postfix(int d, void* buf, size_t nbytes, int64_t offset) {
 (void)d;
 (void)buf;
 (void)nbytes;
 (void)offset;
...
int APS5_VABI pthread_once_nid_postfix(void* once_control, void (*init_routine)()) {
 (void)once_control;
 (void)init_routine;
 NotImplemented_nid_no_patch(__func__);
 return 0;

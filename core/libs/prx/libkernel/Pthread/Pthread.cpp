...
int scePthreadMutexInit(PthreadMutex* mutex, const PthreadMutexattr* attr, const char*) {
...
int scePthreadCondInit(PthreadCond* cond, const PthreadCondattr*, const char*) {
...
int scePthreadCondTimedwait(PthreadCond* cond, PthreadMutex* mutex, unsigned int usec) {
...
int scePthreadAttrSetdetachstate(PthreadAttr* attr, int detachstate) {
...
int scePthreadAttrSetstacksize(PthreadAttr* attr, std::size_t stacksize) {
...
int scePthreadAttrGetstack(const PthreadAttr* attr, void** stackaddr, std::size_t* stacksize) {
...
int scePthreadJoin(Pthread thread, void** retval) {

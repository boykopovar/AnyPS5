...
inline constexpr std::uint8_t TwoByteStringOpMovs = 0xA4;
inline constexpr std::uint8_t TwoByteStringOpCmps = 0xAC;
...
inline constexpr std::uint8_t TwoByteModRmRangeGMax = 0x77;
